 ...
 *   entirety and paste it here, changing the prefix from theme_ to drupalsverige_.
 *   For example:
 *
 *     original: theme_breadcrumb()
 *     theme override: drupalsverige_breadcrumb()
 *
 *   where drupalsverige is the name of your sub-theme. For example, the
...
if (theme_get_setting('drupalsverige_fixed')) {
 ...
 */
function drupalsverige_theme(&$existing, $type, $theme, $path) {
...
function drupalsverige_preprocess_page(&$vars, $hook) {
  ...
  $vars['css_alt'] = drupalsverige_css_reorder($vars['css']);
 ...
 */
function drupalsverige_css_reorder($css) {
  global $theme_info;
...
function drupalsverige_preprocess(&$vars, $hook) {
 ...
 */
/* -- Delete this line if you want to use this function
function drupalsverige_preprocess_node(&$vars, $hook) {
  $vars['sample_variable'] = t('Lorem ipsum.');
}
// */
 ...
 */
/* -- Delete this line if you want to use this function
function drupalsverige_preprocess_comment(&$vars, $hook) {
  $vars['sample_variable'] = t('Lorem ipsum.');
}
// */
 ...
 */
/* -- Delete this line if you want to use this function
function drupalsverige_preprocess_block(&$vars, $hook) {
  $vars['sample_variable'] = t('Lorem ipsum.');
}
// */
/*
